...
class BaseGeneratorLightningModule(pl.LightningModule):
    ...
    def shared_step(self, batched_data):
        ...
        node_logits, edge_logits, reg_loss = self.model(batched_node_data, batched_edge_data)
            
        statistics[f"loss/reg"] = reg_loss

        correct_total = 1.0
        loss_total = 0.0
        loss_total += self.hparams.reg_coef * reg_loss
    ...
    def add_args(parser):
        ...
        parser.add_argument("--vq_vocab_size", type=int, default=1024)
